...
This monorepo contains five independently runnable projects. Preserve each project's dependency files, lockfile, Dockerfile and startup entry point. Read the target project's AGENTS.md, CONTEXT.md and relevant ADRs before business-code changes.
