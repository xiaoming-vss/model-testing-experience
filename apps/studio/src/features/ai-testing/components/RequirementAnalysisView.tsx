import { toRecordArray, toRecord } from '@/shared/utils/value'
...
import { formatRoleConcerns, formatTextList, isJsonText, parseRequirementAnalysisContent, toDisplayText } from '@/features/ai-testing/utils/functionalOutput'
